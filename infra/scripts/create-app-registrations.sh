...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help*)
      ...
      echo ""
      echo "Command"
      echo "    create-app-registrations.sh : Will create two app registrations for the modern-web-app-pattern-dotnet and register settings with App Configuration Svc and Key Vault."
      echo ""
      echo "Arguments"
